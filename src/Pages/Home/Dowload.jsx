        ...
        <div className={cx("center")}>
          ...
          <div className={cx('item-center',"left", "item1")} >
              <div className={cx('text')} >
                ...
                <p>Đăng ký khám / tái khám nhanh theo ngày  <br /> Đăng ký khám theo bác sĩ chuyên khoa <br /> Tái khám theo lịch bệnh</p>
              </div>
              <div className={cx('icon')} >
                <img src="https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn-pkh.longvan.net%2Fprod-partner%2Fbae71420-d9ef-48b7-91a9-0151c50c73da-fcf47d13-a9c5-4be8-aa6c-4d4e9b162c19-icon_dang_ky.svg.svg&w=1920&q=75" alt="" />
              </div>
          </div>
          <div className={cx('item-center',"left", "item2")} >
              <div className={cx('text')} >
                ...
                <p> Đăng ký khám theo bác sĩ chuyên khoa <br /> Tái khám theo lịch bệnh</p>
              </div>
              <div className={cx('icon')} >
                <img src="https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn-pkh.longvan.net%2Fprod-partner%2Fbae71420-d9ef-48b7-91a9-0151c50c73da-fcf47d13-a9c5-4be8-aa6c-4d4e9b162c19-icon_dang_ky.svg.svg&w=1920&q=75" alt="" />
              </div>
          ...
          <div className={cx('item-center',"right", "item4", "reverse")} >
              <div className={cx('text')} >
                ...
                <p>Đăng ký khám / tái khám nhanh theo ngày   Tái khám theo lịch bệnh</p>
              </div>
              <div className={cx('icon')} >
                <img src="https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn-pkh.longvan.net%2Fprod-partner%2Fbae71420-d9ef-48b7-91a9-0151c50c73da-fcf47d13-a9c5-4be8-aa6c-4d4e9b162c19-icon_dang_ky.svg.svg&w=1920&q=75" alt="" />
              </div>
