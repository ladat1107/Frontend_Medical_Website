...
import { faEllipsisVertical, faFilePen, faTrashCan } from '@fortawesome/free-solid-svg-icons'
...
export default function UseMenu(userChoose) {
    ...
    return (
        <React.Fragment>
            <DropdownContext.Provider value={dropdownContextValue}>
                <MenuButton><FontAwesomeIcon icon={faEllipsisVertical} size="lg" /></MenuButton>
                <Menu id="hooks-menu">
                    <MenuItem style={{ color: "#99CC33", }} onClick={createHandleMenuClick('OS Default')}>
                        <FontAwesomeIcon className="me-1" icon={faFilePen} size="lg" /> Cập nhật
                    </MenuItem>
                    <MenuItem style={{ color: "#ff2929", }} onClick={createHandleMenuClick('Light')}>
                        <FontAwesomeIcon className="me-2" icon={faTrashCan} size="lg" /> Xóa</MenuItem>
                </Menu>
