          ...
          <ul>
            ...
            <li>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <FontAwesomeIcon className='icon' icon={faHouseChimneyMedical} style={{ color: "#82868c", }} />
                <span className="flex-1 ms-3 whitespace-nowrap">Phòng ban</span>
              </a>
            </li>
            <li>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg group">
                <FontAwesomeIcon className='icon' icon={faRightFromBracket} style={{ color: "#82868c", }} />
